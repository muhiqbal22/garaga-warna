(function() {
  ...
  // Tambahkan statistik jumlah partikel
  var stats = new Stats();
  stats.setMode(0);
  ...
  var updateStats = function() {
    stats.begin();
    stats.end();
    if (window.pJSDom && window.pJSDom[0].pJS && window.pJSDom[0].pJS.particles && window.pJSDom[0].pJS.particles.array) {
